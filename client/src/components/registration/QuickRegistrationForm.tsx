...
export default function QuickRegistrationForm({ forceCalling }: { forceCalling?: boolean } = {}) {
                ...
                {videoUrl && (videoUrl.startsWith('http://') || videoUrl.startsWith('https://')) ? (
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className="text-xs font-bold text-red-650 hover:text-red-800 transition-colors uppercase tracking-wider block"
                    >
